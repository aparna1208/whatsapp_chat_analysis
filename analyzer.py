...
def run_analyzer():
    ...
    if uploaded_file is not None:
        ...
        # Sidebar to select user and date range
        st.title("Chat log")
        ...
        if st.sidebar.button("Show Analysis"):
            ...
            if selected_user == 'Overall':
                ...
                x, new_df = helper.most_busy_user(df_filtered)
                fig, ax = plt.subplots()
...
#
#
# st._bottom.title("Chat Analyzer")
#
# #upload file
#
# uploaded_file = st._bottom.file_uploader("Choose a file")
# if uploaded_file is not None:
#     bytes_data = uploaded_file.getvalue()
#     data = bytes_data.decode("utf-8")
#     df = preprocessor.preprocess(data)
...
#
#
#     selected_user = st._bottom.selectbox("Show analysis wrt", user_list)
#
#     if st.sidebar.button("Show Analysis"):
#
